...
const CartPage: React.FC = () => {
  ...
  const createOrder = async () => {
    try {
      ...
      const response = await axios.post('http://127.0.0.1:5000/order/createorder', orderData);
  ...
  const initiatePayment = async (
    ...
    try {
      ...
      const response = await axios.post('http://127.0.0.1:5000/createpayment/razorpay', paymentData);
      ...
      if (response.status === 200) {
        ...
        const options = {
          ...
          handler: function (response: any) {
            ...
            (async () => {
              try {
                const verifyResponse = await axios.post('http://127.0.0.1:5000/verifypayment', {
